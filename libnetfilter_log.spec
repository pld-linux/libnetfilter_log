...
%description -l pl
libnetfilter_log to biblioteka przestrzeni u¿ytkownika udostêpniaj±ca
interfejs do pakietów logowanych przez filtr pakietów w j±drze. Jest
czê¶ci± systemu zastêpuj±cego stare logowanie pakietów oparte na
syslogu/dmesgu.

%package devel
Summary:	Header files for libnetfilter_log library
Summary(pl):	Pliki nag³ówkowe biblioteki libnetfilter_log
...
Pliki nag³ówkowe biblioteki libnetfilter_log.
